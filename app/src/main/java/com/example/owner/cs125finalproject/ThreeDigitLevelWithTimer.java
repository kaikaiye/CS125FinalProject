...
public class ThreeDigitLevelWithTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_three_digit_level_timer);
    ...
    private void endGameWin(int numOfSubmissions) {
         ...
         **************************************************/
        Intent i = new Intent(ThreeDigitLevelWithTimer.this, GameEndWin.class);
