...
public class FourDigitLevelWithTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_digit_level_timer);
        ...
        tv = (TextView) findViewById(R.id.fourdigtimer);
        /*************************************************
        ...
        timer = new CountDownTimer(240000, 1000) {
            ...
            public void onFinish() {
                tv.setText("Times Up");
                Log.d("end", "times out");
                Intent i = new Intent(FourDigitLevelWithTimer.this, GameEndLoss.class);
                startActivity(i);
            }
        }.start();
    ...
    private void endGameWin(int numOfSubmissions) {
         ...
         **************************************************/
        Intent i = new Intent(FourDigitLevelWithTimer.this, GameEndWin.class);
